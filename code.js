...
var wall3 = createSprite(windowWidth/2,windowHeight-800,windowWidth+600,20);
var wall4 = createSprite(windowWidth/2,windowHeight+190,windowWidth+600,20);
...
function setup(){
  ...
  up = createSprite(windowWidth/2-420,windowWidth/2-480);
  up.scale= 0.3;
  up.addImage(upImg);

  down = createSprite(windowWidth/2+420,windowWidth/2-480);
  down.scale= 0.3;
